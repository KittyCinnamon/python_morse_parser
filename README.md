...
1. when mouse is clicked (or held down) saves the info as Click(.) or Hold(-)
2. when SPACE is pressed divides the letters
3. when TAB is pressed divides the words
